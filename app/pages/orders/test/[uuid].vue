            ...
            <div v-if="test && order" ref="advancedMenuRef" class="relative shrink-0 ml-auto">
                ...
                <Transition name="menu-fade">
                    <div v-if="advancedMenuOpen"
                        ...
                        <button type="button"
                            class="w-full flex items-center gap-2 px-3 py-2 text-sm sm:text-base text-on-surface hover:bg-surface-low transition-colors"
                            @click="printLabel(test?.accession_number, test?.accession_number)">
                            <font-awesome-icon :icon="['fas', 'barcode']" class="text-ribbon-red shrink-0" />
                            <span class="inline-block">Print Order Test Barcode</span>
                        </button>
                    </div>
                </Transition>
            </div>
            ...
            <div v-if="visible"
                ...
                <div class="flex items-center gap-3 px-5 py-4">
                    <div class="w-10 h-10 rounded-full flex items-center justify-center shrink-0 transition-colors duration-300"
                        ...
                        <font-awesome-icon v-if="status === 'loading'" :icon="['fas', 'print']"
