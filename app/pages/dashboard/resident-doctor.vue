<!-- app/pages/dashboard/resident-doctor.vue -->
<!--
  Resident Doctor dashboard — fully self-contained. Live GET /dashboard
  (role=resident_doctor). No shared dashboard components: header, KPI tiles, bars,
